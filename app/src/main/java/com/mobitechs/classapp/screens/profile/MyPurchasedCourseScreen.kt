...
@Composable
fun MyPurchasedCourseScreen(
    viewModel: MyPurchasedCourseViewModel,
    ...
    Scaffold(
        topBar = {
            if (isSearchActive) {
                ...
                TopAppBar(
                    title = { Text("My Purchased Course") },
                    navigationIcon = {
            ...
            when {
                ...
                uiState.error.isNotEmpty() -> {
                    ErrorView(
                        ...
                        onRetry = { viewModel.loadPurchasedCourses() }
                    )
                }
                ...
                uiState.filteredCourses.isEmpty() -> {
                    ...
                    CourseCardEmptyMessageWithoutBox(
                        message = if (searchQuery.isNotEmpty())
                            ...
                            "No courses in your purchased history.",
